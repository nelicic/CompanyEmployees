...
internal sealed class EmployeeService : IEmployeeService
{
        ...
        LinkParameters linkParameters, bool trackChanges)
    {
        ...
        var employeesWithMediaData = await _repository.Employee.GetEmployeesAsync(companyId, linkParameters.EmployeeParameters , trackChanges);   
        ...
        return (linkResponse: links, metaData: employeesWithMediaData.MetaData);
    }
